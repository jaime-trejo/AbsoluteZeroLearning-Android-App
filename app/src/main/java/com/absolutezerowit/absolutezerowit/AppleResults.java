...
public class AppleResults extends Activity {

    Button eButton,cButton,exitSubjectButton;
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(winOrLoseResult.equalsIgnoreCase("win"))
        {
            ...
            image.setImageBitmap(
                    decodeSampledBitmapFromResource(getResources(), R.drawable.happy4, 115, 115));
            ...
            cButton.setOnClickListener((new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(AppleResults.this, MathSubject.class);
            ...
            exitSubjectButton.setOnClickListener(( new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    returnSubjectIntent.setClass(AppleResults.this, SubjectMenu.class);
            ...
            image.setImageBitmap(
                    decodeSampledBitmapFromResource(getResources(), R.drawable.red, 115, 115));
            ...
            cButton.setOnClickListener((new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // switch activity
                    Intent intent = new Intent();
                    intent.setClass(AppleResults.this, dragApple.class);
                    startActivity(intent);
            ...
            exitSubjectButton.setOnClickListener(( new OnClickListener() {
                ...
                public void onClick(View v) {
                    // switch activity
                    Intent returnSubjectIntent = new Intent();
                    returnSubjectIntent.setClass(AppleResults.this, MathSubject.class);
                    startActivity(returnSubjectIntent);
                }
            }));
